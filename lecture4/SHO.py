...
graph1=graph(xtitle="time", ytitle="x-coordinate", xmin=0, xmax=20, ymin=10, ymax=50)
graph2=graph(xtitle="time", ytitle="velocity", xmin=0, xmax=20, ymin=-20, ymax=20)
graph3=graph(xtitle="time", ytitle="Energy", xmin=0, xmax=20, ymin=0, ymax=70)
